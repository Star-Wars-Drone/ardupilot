...
#FIXME Added DB410C board as subtype
ifneq ($(findstring db410c, $(MAKECMDGOALS)),)
HAL_BOARD = HAL_BOARD_LINUX
HAL_BOARD_SUBTYPE = HAL_BOARD_SUBTYPE_LINUX_DB410C
endif

#FIXME Added HIKEY board as subtype
ifneq ($(findstring hikey, $(MAKECMDGOALS)),)
HAL_BOARD = HAL_BOARD_LINUX
HAL_BOARD_SUBTYPE = HAL_BOARD_SUBTYPE_LINUX_HIKEY
endif
